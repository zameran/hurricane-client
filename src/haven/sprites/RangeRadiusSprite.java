...
public class RangeRadiusSprite extends Sprite {
	static final Pipe.Op blacc = Pipe.Op.compose(new BaseColor(new Color(0, 0, 0, 140)), new States.LineWidth(4), Clickable.notClickable);
	...
	public RangeRadiusSprite(final Owner owner, final Resource resource, final float n, Color col) {
		super(owner, resource);
		this.col = Pipe.Op.compose(new BaseColor(col), Clickable.notClickable);
		init(n);
	}
