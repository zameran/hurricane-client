...
public class FloatText extends FloatSprite {
    ...
    public FloatText(Owner owner, Resource res, String str, Color col, int damageType) {
        super(owner, res, new TexI(Utils.outline2(fnd.renderstroked(str, col, Color.BLACK).img, Color.BLACK,true)), 2, damageType);
    }
}
