...
public class HitBoxGobSprite<T extends RenderTree.Node> extends Sprite {
    private boolean visible;
    final Collection<RenderTree.Slot> slots = new ArrayList<>(1);
    public final T fx;

    protected HitBoxGobSprite(Gob gob, T fx) {
	this(gob, fx, true);
    }

    protected HitBoxGobSprite(Gob gob, T fx, boolean visible) {
	super(gob, null);
	this.fx = fx;
